...
const HeroBanner = () => (
  <div className="mt-12 lg:mt-32 ml-8 sm:ml-12 md:ml-20 flex">
    <div>
      ...
      <a href="#SearchExercises" className="inline-block bg-yellow-600 text-white py-3 px-2 lg:py-4 lg:px-8 rounded-lg text-lg lg:text-xl font-semibold hover:bg-yellow-700 transition duration-300">Explore Exercises</a>
    </div>
    <div>
